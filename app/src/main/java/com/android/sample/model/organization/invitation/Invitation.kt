...
fun InvitationStatus.getStringId(): Int =
    when (this) {
      InvitationStatus.Active -> R.string.status_active
      InvitationStatus.Used -> R.string.status_used
      InvitationStatus.Expired -> R.string.status_expired
    }
