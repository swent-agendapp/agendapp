 ...
 * [ReplacementEmployeeListScreen].
 *
 * Date/time formatting is currently kept simple to avoid dependency on date utils.
 * You can later replace the `toString()` calls with proper formatting using `DateTimeUtils`.
 */
private fun Replacement.toUi(): ReplacementRequestUi {
    ...
    val weekdayAndDay = start.toLocalDate().toString() // TODO: use a nicer "Monday 7" formatting
